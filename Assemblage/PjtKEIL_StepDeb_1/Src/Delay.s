...
VarTime	dcd 0 ;à Vartime qui est une adresse, y a la donnée 0
...
Delay_100ms proc
	    ...
	    ldr r0,=VarTime ;stock adresse de Vartime dans R0	  
						  
		ldr r1,=TimeValue ;stock adresse de TimeValue dans R1
		str r1,[r0] ;Vartime = TimeValue
		
BoucleTempo	;temps de la boucle = 100ms 
		ldr r1,[r0]     				
						
		subs r1,#1
		str  r1,[r0]
		bne	 BoucleTempo ;fait la boucle tant que r1 !=0
			
		bx lr ;stock dans lr l'adresse de l'instruction suivante
		endp
